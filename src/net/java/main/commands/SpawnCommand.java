...
private Repository<net.java.main.interfaces.Unit> unitRepository;

    public SpawnCommand(Battleground battleground, Repository<net.java.main.interfaces.Unit> unitRepository) {
    ...
    public String execute(String[] args) throws InvalidUnitTypeException, InvalidPositionException {
        ...
        BaseUnit unit = UnitFactory.createUnit(unitType, unitName, xPosition,yPosition);
